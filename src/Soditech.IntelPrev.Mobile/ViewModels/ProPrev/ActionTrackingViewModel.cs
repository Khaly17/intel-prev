...
class ActionTrackingViewModel : MauiViewModel
{
    ...
    public string DefinitionText
    {
        ...
        set
        {
            ...
            _definitionText = $"<html><head><style>body {{ font-size: 18px; color: #424242; line-height: 1.6; }}</style></head><body>{value}</body></html>";
            OnPropertyChanged();
        }
    }
