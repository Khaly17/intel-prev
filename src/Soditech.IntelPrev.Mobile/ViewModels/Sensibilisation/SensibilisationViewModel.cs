...
public class SensibilisationViewModel : MauiViewModel
{
	...
	public static string OverviewTitle => "Sensibilisation";
	...
	private void InitializeCollections()
	{
		...
		RiskCategories =
		[
			new() { Name = "Physique", IconSource = "physical_risk.jpg" },
			new() { Name = "Risques liés aux gestes répétitifs", IconSource = "repetitive_risk.png" },
			new() { Name = "Risques liés aux déplacements", IconSource = "travel_risk.png" },
			new() { Name = "Risques biologiques", IconSource = "biological_risk.png" },
			new() { Name = "Risques chimiques", IconSource = "chemical_risk.png" },
			new() { Name = "Risques liés aux conditions de sécurité", IconSource = "safety_risk.png" },
			new() { Name = "Risques psychosociaux (RPS)", IconSource = "psycho_risk.png" },
			new() { Name = "Risques liés aux machines et équipements", IconSource = "machine_risk.png" }
		];

		PreventionTips =
		[
			new() { TipText = "Donner du sens à la sécurité au travail", TutorialLink = "TutorialPage1" },
			new() { TipText = "La formation des salariés", TutorialLink = "TutorialPage2" },
			new() { TipText = "Le rappel des messages de sensibilisation", TutorialLink = "TutorialPage3" },
			new() { TipText = "L'implication de tous les acteurs de l'entreprise", TutorialLink = "TutorialPage4" },
			new()
			{
				TipText = "La planification des actions de prévention et de sensibilisation",
				TutorialLink = "TutorialPage5"
			},
			new() { TipText = "L'identification des risques et des dangers", TutorialLink = null }
		];
	}
