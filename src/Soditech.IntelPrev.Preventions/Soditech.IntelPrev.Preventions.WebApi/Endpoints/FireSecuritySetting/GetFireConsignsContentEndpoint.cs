...
[HttpGet(PreventionRoutes.FireSecuritySettings.GetFireConsignsContent)]
[Tags("FireConsignsContent")]
public class GetFireConsignsContentEndpoint(IServiceProvider serviceProvider): EndpointWithoutRequest<TResult<FireSecuritySettingContentResult>>
{
    ...
    {
        var request = new FireConsignsContentQuery();
