...
[HttpGet(PreventionRoutes.ProPrevSettings.GetSitesVisitContent)]
[Tags("SitesVisit")]
public class GetSitesVisitContentEndpoint(IServiceProvider serviceProvider): EndpointWithoutRequest<TResult<ProPrevContentResult>>
{
    private readonly IMediator _mediator = serviceProvider.GetRequiredService<IMediator>();
    
    public override async Task<TResult<ProPrevContentResult>> HandleAsync(CancellationToken cancellationToken)
    {
        var request = new SitesVisitContentQuery();
