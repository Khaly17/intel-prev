...
public class UpdateFirstAidKitContentCommandHandler(IServiceProvider serviceProvider) : IRequestHandler<FirstAidKitContentCommand, Result>
{
    ...
    /// <inheritdoc />
    public async Task<Result> Handle(FirstAidKitContentCommand request, CancellationToken cancellationToken)
    {
        try
        {
            ...
            proPrevSettings.FirstAidKitContent = request.Content;
