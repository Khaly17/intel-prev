...
public class UpdateRiskAnalysisProtocolContentCommandHandler(IServiceProvider serviceProvider): IRequestHandler<UpdateRiskAnalysisProtocolContentCommand, Result>
{
    ...
    /// <inheritdoc />
    public async Task<Result> Handle(UpdateRiskAnalysisProtocolContentCommand request, CancellationToken cancellationToken)
    {
        try
        {
            ...
            proPrevSettings.RiskAnalysisProtocolContent = request.Content;
