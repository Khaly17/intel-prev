...
public class UpdateMyLibraryContentCommandHandler(IServiceProvider serviceProvider) : IRequestHandler<MyLibraryContentCommand, Result>
{
    ...
    /// <inheritdoc />
    public async Task<Result> Handle(MyLibraryContentCommand request, CancellationToken cancellationToken)
    {
        try
        {
            ...
            proPrevSettings.MyLibraryContent = request.Content;
