...
public class UpdateSitesVisitContentCommandHandler(IServiceProvider serviceProvider) : IRequestHandler<SitesVisitContentCommand, Result>
{
    ...
    /// <inheritdoc />
    public async Task<Result> Handle(SitesVisitContentCommand request, CancellationToken cancellationToken)
    {
        try
        {
            ...
            proPrevSettings.SitesVisitContent = request.Content;
