...
public partial class DocumentsIndex
{
    ...
    [
        new() { Field = nameof(DocumentResult.Name), HeaderText = "Nom" },
        new() { Field = nameof(DocumentResult.Type), HeaderText = "Type" },
        new() { Field = nameof(DocumentResult.FileType), HeaderText = "Type de fichier" },
        new() { Field = nameof(DocumentResult.IsDownloadable), HeaderText = "Téléchargeable" , DisplayAsCheckBox = true}
    ];
