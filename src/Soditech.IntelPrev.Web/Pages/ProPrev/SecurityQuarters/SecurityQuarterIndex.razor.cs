...
public partial class SecurityQuarterIndex
{
    [Inject]
    ...
    {
        var result = await ProxyService.GetAsync<ProPrevContentResult>(PreventionRoutes.ProPrevSettings.GetSecurityQuarterContent);
        if (result.IsSuccess)
        {
