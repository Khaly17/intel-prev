...
namespace Soditech.IntelPrev.Web.Pages.ProPrev.MyLibraryContents;

public partial class MyLibraryIndex
{
    [Inject]
    private ILogger<MyLibraryIndex> Logger { get; set; } = default!;
    ...
    private async Task SaveContent()
    {
        ...
        try
        {
            ...
            {
                var result = await ProxyService.PostAsync<ProPrevContentResult>(PreventionRoutes.ProPrevSettings.UpdateMyLibraryContent, newProPrevContentResult);
