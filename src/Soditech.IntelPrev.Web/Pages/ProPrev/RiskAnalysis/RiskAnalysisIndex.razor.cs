...
namespace Soditech.IntelPrev.Web.Pages.ProPrev.RiskAnalysis;

public partial class RiskAnalysisIndex
{
    [Inject]
    private ILogger<RiskAnalysisIndex> Logger { get; set; } = default!;
    ...
    private async Task SaveContent()
    {
        ...
        try
        {
            ...
            {
                var result = await ProxyService.PostAsync<ProPrevContentResult>(PreventionRoutes.ProPrevSettings.UpdateRiskAnalysisProtocolContent, newProPrevContentResult);
    ...
    {
        var result = await ProxyService.GetAsync<ProPrevContentResult>(PreventionRoutes.ProPrevSettings.GetRiskAnalysisProtocolContent);
        if (result.IsSuccess)
        {
