...
namespace Soditech.IntelPrev.Web.Pages.ProPrev.AnalysisTools;

public partial class AnalysisToolsIndex
{
    [Inject]
    private ILogger<AnalysisToolsIndex> Logger { get; set; } = default!;
    ...
    private async Task SaveContentAsync()
    {
        ...
        try
        {
            ...
            {
                var result = await ProxyService.PostAsync<ProPrevContentResult>(PreventionRoutes.ProPrevSettings.UpdateAnalysisToolsContent, NewProPrevContentResult);
