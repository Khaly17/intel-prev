...
namespace Soditech.IntelPrev.Web.Pages.ProPrev.CseAgendas;

public partial class CseAgendaIndex
{
    [Inject]
    private ILogger<CseAgendaIndex> Logger { get; set; } = default!;
    ...
    private async Task SaveContent()
    {
        ...
        try
        {
            ...
            {
                var result = await ProxyService.PostAsync<ProPrevContentResult>(PreventionRoutes.ProPrevSettings.UpdateCseAgendaContent, NewProPrevContentResult);
