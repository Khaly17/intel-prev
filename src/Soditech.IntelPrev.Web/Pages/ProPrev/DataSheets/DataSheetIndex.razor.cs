...
namespace Soditech.IntelPrev.Web.Pages.ProPrev.DataSheets;

public partial class DataSheetIndex
{
    [Inject]
    private ILogger<DataSheetIndex> Logger { get; set; } = default!;
    ...
    private async Task SaveContentAsync()
    {
        ...
        try
        {
            ...
            {
                var result = await ProxyService.PostAsync<ProPrevContentResult>(PreventionRoutes.ProPrevSettings.UpdateDataSheetContent, NewProPrevContentResult);
    ...
    {
        var result = await ProxyService.GetAsync<ProPrevContentResult>(PreventionRoutes.ProPrevSettings.GetDataSheetContent);
        if (result.IsSuccess)
        {
