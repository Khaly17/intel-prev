...
namespace Soditech.IntelPrev.Web.Pages.ProPrev.FirstAidKitContents;

public partial class FirstAidKitIndex
{
    [Inject]
    private ILogger<FirstAidKitIndex> Logger { get; set; } = default!;
    ...
    private async Task SaveContentAsync()
    {
        ...
        try
        {
            ...
            {
                var result = await ProxyService.PostAsync<ProPrevContentResult>(PreventionRoutes.ProPrevSettings.UpdateFirstAidKitContent, NewProPrevContentResult);
    ...
    {
        var result = await ProxyService.GetAsync<ProPrevContentResult>(PreventionRoutes.ProPrevSettings.GetFirstAidKitContent);
        if (result.IsSuccess)
        {
